...
import static com.exception.message.CommonExceptionMessage.INVALID_INPUT_VALUE;
...
//
//        RentResponseDto rentBookResponseDto = objectMapper.readValue(rentResponse.getContentAsString(), RentResponseDto.class);
//
//        assertEquals(bookResponseDto.getId(), rentBookResponseDto.getBookId());
//    }
//
//
